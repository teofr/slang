...
language_v2_macros::compile!(Language(
    ...
    evm_targets = [
        ...
        Istanbul, Berlin, London, Paris, Shanghai, Cancun, Prague, Osaka, Amsterdam
    ],
    contexts = [
        LexicalContext(
            name = Pragma,
...
TypeName0<FunctionRule, IAPRule>: TypeName = {
    ...
    <l:@L> <index_access_path: IAPRule> => parser_helpers::new_type_name_index_access_path(index_access_path, l, ctx),
};
...
IdentifierPathTailElements: Vec<IdentifierPathElement> = {
            ...
            scopes = [
                BuiltInScope(
                    ...
                    definitions = [
                        ...
                        BuiltInDefinition(name = Erc7201, enabled = From("0.8.35")),
    ...
    yul_reserved_words = [
        YulReservedWord(name = dup1),
        YulReservedWord(name = dup2),
        YulReservedWord(name = dup3),
        YulReservedWord(name = dup4),
        YulReservedWord(name = dup5),
        YulReservedWord(name = dup6),
        YulReservedWord(name = dup7),
        YulReservedWord(name = dup8),
        YulReservedWord(name = dup9),
        YulReservedWord(name = dup10),
        YulReservedWord(name = dup11),
        YulReservedWord(name = dup12),
        YulReservedWord(name = dup13),
        YulReservedWord(name = dup14),
        YulReservedWord(name = dup15),
        YulReservedWord(name = dup16),
        YulReservedWord(name = swap1),
        YulReservedWord(name = swap2),
        YulReservedWord(name = swap3),
        YulReservedWord(name = swap4),
        YulReservedWord(name = swap5),
        YulReservedWord(name = swap6),
        YulReservedWord(name = swap7),
        YulReservedWord(name = swap8),
        YulReservedWord(name = swap9),
        YulReservedWord(name = swap10),
        YulReservedWord(name = swap11),
        YulReservedWord(name = swap12),
        YulReservedWord(name = swap13),
        YulReservedWord(name = swap14),
        YulReservedWord(name = swap15),
        YulReservedWord(name = swap16),
        YulReservedWord(name = push1),
        YulReservedWord(name = push2),
        YulReservedWord(name = push3),
        YulReservedWord(name = push4),
        YulReservedWord(name = push5),
        YulReservedWord(name = push6),
        YulReservedWord(name = push7),
        YulReservedWord(name = push8),
        YulReservedWord(name = push9),
        YulReservedWord(name = push10),
        YulReservedWord(name = push11),
        YulReservedWord(name = push12),
        YulReservedWord(name = push13),
        YulReservedWord(name = push14),
        YulReservedWord(name = push15),
        YulReservedWord(name = push16),
        YulReservedWord(name = push17),
        YulReservedWord(name = push18),
        YulReservedWord(name = push19),
        YulReservedWord(name = push20),
        YulReservedWord(name = push21),
        YulReservedWord(name = push22),
        YulReservedWord(name = push23),
        YulReservedWord(name = push24),
        YulReservedWord(name = push25),
        YulReservedWord(name = push26),
        YulReservedWord(name = push27),
        YulReservedWord(name = push28),
        YulReservedWord(name = push29),
        YulReservedWord(name = push30),
        YulReservedWord(name = push31),
        YulReservedWord(name = push32),
        YulReservedWord(name = jump),
        YulReservedWord(name = jumpi),
        YulReservedWord(name = jumpdest),
        YulReservedWord(name = datasize),
        YulReservedWord(name = dataoffset),
        YulReservedWord(name = datacopy),
        YulReservedWord(name = linkersymbol),
        YulReservedWord(name = setimmutable),
        YulReservedWord(name = loadimmutable),
        YulReservedWord(name = difficulty),
        YulReservedWord(name = push0, enabled = From("0.8.20"))
    ]
));
