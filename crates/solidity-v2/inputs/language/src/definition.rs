...
StateVariableDefinition: StateVariableDefinition = {
    ...
    <l:@L> L_ErrorKeyword_Unreserved <r:@R>  <attributes: StateVariableAttributes>  <name: Identifier>  <value: (StateVariableDefinitionValue)?>  <semicolon: Semicolon> => {
        ...
        let iap = parser_helpers::new_index_access_path_from_separated_identifier_path(parser_helpers::SeparatedIdentifierPath::single(identifier));
...
IdentifierPathNoError: parser_helpers::SeparatedIdentifierPath = {
    ...
    <head: Identifier>  <tail: Repeated<IdentifierPathTailElement>>  => parser_helpers::SeparatedIdentifierPath::new(<>),
    // or a single identifier that is not `error`
    <head: SomeIdentifier<"ErrorKeyword_Unreserved">>  => parser_helpers::SeparatedIdentifierPath::single(<>),
};
...
IdentifierPathNoRevert: parser_helpers::SeparatedIdentifierPath = {
    ...
    <head: SomeIdentifier<"RevertKeyword_Unreserved">>  => parser_helpers::SeparatedIdentifierPath::single(<>),
};
                                        )
                                    )
                                ),
...
IdentifierPath: IdentifierPath = {
    <path: SeparatedIdentifierPath>  => path.into_identifier_path(),
...
SeparatedIdentifierPath: parser_helpers::SeparatedIdentifierPath = {
    <head: Identifier>  => parser_helpers::SeparatedIdentifierPath::single(<>),
    <head: Identifier>  <tail: Repeated<IdentifierPathTailElement>>  => parser_helpers::SeparatedIdentifierPath::new(<>),

};
// Each element after the head, paired with the period that precedes it.
// Inlined so that reusing `Repeated` doesn't cost an extra reduction per element.
#[inline]
